...
class UserBottomMenu extends Component {
    ...
    render () {
        ...
        return (
            <BottomMenu id={'user-menu'} isVisible={isVisible} handleHide={hideVisibleMenu}>
                {studentGroup}
                {rows}
            </BottomMenu>
        )
...
export default connect(mapStateToProps, { hideVisibleMenu })(UserBottomMenu)